...
Restriction[reps_] := Module[{dim, len, diag, permuted, candidates, result},
    ...
    result = Last@Reap@Monitor[Do[
        ...
        Sow[<|
            "S" -> #[[1]][[1;;dim/3, 1;;dim/3]],
            "T" -> #[[2]]
        |>]&/@Select[candidates, ReducibleQ[#[[1]]]&],
        {i, len}
